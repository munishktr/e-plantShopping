...
function ProductList({ onHomeClick }) {
    ...
    const cartCount = cartItems.reduce((total, item) => total + item.quantity, 0); // display item quantity on the cart icon
    ...
    return (
        <div>
            ...
            {!showCart ? (
                ...
                <CartItem onContinueShopping={handleContinueShopping} totalItems={cartCount} />
            )}
        </div>
    );
}
